...
- `App.tsx` 和 Practice routes 仍偏大；Practice repository、Learning repository、Admin Question Review 与 Admin Students 已拆成模块，但 submit service、route validation、Bank Mappings 大文件与错误映射仍待后续分离。

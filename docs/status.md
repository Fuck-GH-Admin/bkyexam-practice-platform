...
- `App.tsx` 和 Practice routes 仍偏大；Practice repository、Learning repository 与 Admin Question Review 已拆成模块，但 submit service、route validation、Admin Students/Bank Mappings 大文件与错误映射仍待后续分离。

...
- `App.tsx` 和 Practice routes 仍偏大；Practice repository 与 Learning repository 已拆成模块，但 submit service、route validation、Admin 大文件与错误映射仍待后续分离。
